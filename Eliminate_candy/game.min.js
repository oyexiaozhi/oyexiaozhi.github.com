...
a[0]+e*a[4]+f*a[8]+a[12];this.y=b*a[1]+e*a[5]+f*a[9]+a[13];this.z=b*a[2]+e*a[6]+f*a[10]+a[14];return this};b.transformNormal=function(a){var b=this.x,e=this.y,f=this.z;a=a.mat;this.x=b*a[0]+e*a[4]+f*a[8];this.y=b*a[1]+e*a[5]+f*a[9];this.z=b*a[2]+e*a[6]+f*a[10];return this};b.transformCoord=function(c){var b=new a.math.Vec4(this.x,this.y,this.z,1);b.transform(c);this.x=b.x/b.w;this.y=b.y/b.w;this.z=b.z/b.w;return this};b.scale=function(a){this.x*=a;this.y*=a;this.z*=a;return this};b.equals=function(c){var b=
a.math.EPSILON;return this.x<c.x+b&&this.x>c.x-b&&this.y<c.y+b&&this.y>c.y-b&&this.z<c.z+b&&this.z>c.z-b};b.inverseTransform=function(c){c=c.mat;var b=new a.math.Vec3(this.x-c[12],this.y-c[13],this.z-c[14]);this.x=b.x*c[0]+b.y*c[1]+b.z*c[2];this.y=b.x*c[4]+b.y*c[5]+b.z*c[6];this.z=b.x*c[8]+b.y*c[9]+b.z*c[10];return this};b.inverseTransformNormal=function(a){var b=this.x,e=this.y,f=this.z;a=a.mat;this.x=b*a[0]+e*a[1]+f*a[2];this.y=b*a[4]+e*a[5]+f*a[6];this.z=b*a[8]+e*a[9]+f*a[10];return this};b.assignFrom=
...
t;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],u=k[6],t=k[7],v=k[8],w=k[9],y=k[10],z=k[11],x=k[12],A=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*v+F*x;d[1]=C*b+D*r+E*w+F*A;d[2]=C*n+D*u+E*y+F*B;d[3]=C*p+D*t+E*z+F*k;d[4]=G*c+H*s+I*v+J*x;d[5]=G*b+H*r+I*w+J*A;d[6]=G*n+H*u+I*y+J*B;d[7]=G*p+H*t+I*
z+J*k;d[8]=K*c+L*s+M*v+N*x;d[9]=K*b+L*r+M*w+N*A;d[10]=K*n+L*u+M*y+N*B;d[11]=K*p+L*t+M*z+N*k;d[12]=O*c+P*s+Q*v+m*x;d[13]=O*b+P*r+Q*w+m*A;d[14]=O*n+P*u+Q*y+m*B;d[15]=O*p+P*t+Q*z+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],u=b[8],t=b[9],v=b[10],w=b[11],y=b[12],z=b[13],x=b[14],A=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*u+E*y;b[1]=
B*d+C*p+D*t+E*z;b[2]=B*k+C*s+D*v+E*x;b[3]=B*m+C*r+D*w+E*A;b[4]=F*a+G*n+H*u+I*y;b[5]=F*d+G*p+H*t+I*z;b[6]=F*k+G*s+H*v+I*x;b[7]=F*m+G*r+H*w+I*A;b[8]=J*a+K*n+L*u+M*y;b[9]=J*d+K*p+L*t+M*z;b[10]=J*k+K*s+L*v+M*x;b[11]=J*m+K*r+L*w+M*A;b[12]=N*a+O*n+P*u+c*y;b[13]=N*d+O*p+P*t+c*z;b[14]=N*k+O*s+P*v+c*x;b[15]=N*m+O*r+P*w+c*A;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];k[1]=c[1]*d[0]+c[5]*d[1]+c[9]*d[2]+c[13]*d[3];
...
n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,s=0;s<d;s++){var r=c.charCodeAt(s)-a._mapStartChar.charCodeAt(0),u=r%a._itemsPerRow,t=0|r/a._itemsPerRow,v;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(u=(2*u*h+1)/(2*g),r=u+(2*h-2)/(2*g),t=(2*t*k+1)/(2*f),v=t+(2*k-2)/(2*f)):(u=u*h/g,r=u+h/g,t=t*k/f,v=t+k/f);var w=m[s],y=w.tl,z=w.tr,x=w.bl,w=w.br;y.texCoords.u=u;y.texCoords.v=t;z.texCoords.u=r;z.texCoords.v=t;x.texCoords.u=u;x.texCoords.v=v;w.texCoords.u=r;w.texCoords.v=v;x.vertices.x=s*p;x.vertices.y=
0;x.vertices.z=0;w.vertices.x=s*p+p;w.vertices.y=0;w.vertices.z=0;y.vertices.x=s*p;y.vertices.y=a._itemHeight;y.vertices.z=0;z.vertices.x=s*p+p;z.vertices.y=a._itemHeight;z.vertices.z=0;y.colors=n;z.colors=n;x.colors=n;w.colors=n}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
this._currentStencilEnabled||a.disable(a.STENCIL_TEST);cc.ClippingNode.WebGLRenderCmd._layer--}})();var g_resources="res/1.png res/2.png res/3.png res/4.png res/5.png res/bg.jpg".split(" ");var Constant={CANDY_WIDTH:64,CANDY_TYPE_COUNT:5,FALL_ACCELERATION:30,MAP_SIZE:10,levels:[{limitStep:30,targetScore:500},{limitStep:25,targetScore:1E3},{limitStep:20,targetScore:2E3},{limitStep:20,targetScore:3E3},{limitStep:15,targetScore:4E3},{limitStep:10,targetScore:5E3}]};var Storage={getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||0;return parseInt(a)},setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a);return!0},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a);return!0}};var GameUI=cc.Layer.extend({levelText:null,scoreText:null,stepText:null,gameLayer:null,ctor:function(a){this._super();this.gameLayer=a;this._initIofoPanel();this.scheduleUpdate()},_initIofoPanel:function(){var a=cc.director.getWinSize(),b=new cc.LabelTTF("Level","arial","36");b.x=100;b.y=a.height-50;b.setColor(cc.color(0,0,0));this.addChild(b);a=new cc.LabelTTF("1","arial",36);a.x=100;a.y=b.y-40;a.setColor(cc.color(0,0,0));this.addChild(a);this.levelText=a;var c=new cc.LabelTTF("Score","arial",36);
...
var a=new gameLayer;this.addChild(a)}});trace=function(){cc.log(Array.prototype.join.call(arguments,","))};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new gameScene)},this)};cc.game.run();